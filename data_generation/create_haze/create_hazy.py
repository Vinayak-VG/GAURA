...
import create_haze.tool_kit as tk
from create_haze.parameter import const

def gen_haze(img_path, save_path, depth_path, Beta, A):
    ...
    depth_img = np.repeat(np.expand_dims(depth_img, axis = -1), 3, axis = -1)
