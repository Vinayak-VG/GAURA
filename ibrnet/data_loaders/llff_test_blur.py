...
class LLFFTestBlurDataset(Dataset):
    
    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        
        # if args.ft_corrup == "motion" or args.ft_corrup == "defocus":
        #     self.CORRUPTIONS_in = [
        #     ("_motionblur1", 0),
        #     ]
        ...
        self.folder_path = os.path.join("/data/New_Data_Gen/data/nerf_llff_data/")
        self.args = args
    ...
    def __getitem__(self, idx):
        ...
        # postfix1, embed_id1 = "_burstnoise2", 2
