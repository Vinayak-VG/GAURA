...
class RealRainDataloader(Dataset):

    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        # self.folder_path = os.path.join("/data/cilab4090/restoration_nerf/real_data/rain")
        self.folder_path = os.path.join("/home/vinayak/restoration_nerf_finalsprint/real_data/rain")
        self.args = args
    ...
    def __getitem__(self, idx):
        ...
        # if os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "rb3_Rain":
        postfix1, embed_id1 = "", 2 # 7, 8, 9
