...
class IBRNetCollectedDatasetDynamic(Dataset):
    
    def __init__(self, args, mode, random_crop=True, **kwargs):

        self.args = args
        self.folder_path1 = os.path.join("/home/vinayak/restoration_nerf_finalsprint/data/ibrnet_collected_1/")
        self.folder_path2 = os.path.join("/home/vinayak/restoration_nerf_finalsprint/data/ibrnet_collected_2/")
