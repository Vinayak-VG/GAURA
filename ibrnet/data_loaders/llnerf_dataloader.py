...
class LLNeRFDataloader(Dataset):
    CORRUPTIONS = [
        ("", 0),
        # ("_defocus1", 1),
        # ("_defocus2", 1),
    ...
    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        self.folder_path = os.path.join("/home/vinayak/restoration_nerf_finalsprint/real_data/dark/llnerf")
        self.args = args
        ...
        for i, scene in enumerate(scenes):
            ...
            _, poses, bds, render_poses, i_test, rgb_files = load_llff_data(
                scene_path, load_imgs=False, factor=1
            )
    ...
    def __getitem__(self, idx):
        ...
        # postfix1, embed_id1 = random.choice(self.CORRUPTIONS)
        # postfix2, embed_id2 = random.choice(self.CORRUPTIONS)

        rgb_file_ = self.render_rgb_files[idx]
        if os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "still2":
            postfix1, embed_id1 = "_dark1", 0 # 7, 8, 9
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "still3":
            postfix1, embed_id1 = "_dark1", 0
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "still4":
            postfix1, embed_id1 = "_dark1", 0
