...
class RevideDataloader(Dataset):

    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        self.folder_path = os.path.join("/home/vinayak/restoration_nerf_finalsprint/real_data/haze/final_revide/")
        self.args = args
    ...
    def __getitem__(self, idx):
        ...
        # if os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "E006":
        #     postfix1, embed_id1 = "_haze1", 10
        # elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "J004":
        #     postfix1, embed_id1 = "_haze1", 10
        # elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "W002":
        #     postfix1, embed_id1 = "_haze1", 10
        postfix1, embed_id1 = "_haze1", 1
        ...
        for id in nearest_pose_ids:
            ...
            try:
                src_rgb = imageio.imread(src_rgb_file.replace(".JPG", ".png")).astype(np.float32) / 255.0
            except:
