...
class AlethLOMDataset(Dataset):
    def __init__(
        ...
        **kwargs
        ...
        self.folder_path = os.path.join("/home/vinayak/restoration_nerf_finalsprint/real_data/dark/LOM_full")
        ...
        all_scenes = ('bike', 'buu', 'chair', 'shrub', 'sofa')
        if len(scenes) > 0:
        ...
        for scene in scenes:
            ...
            for i in range(len(rgb_files)):
                rgb_files[i] = rgb_files[i].replace("low", "high")
    ...
    def __getitem__(self, idx):
        ...
        if os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "buu":
            postfix1, embed_id1 = "_dark1", 0
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "chair":
            postfix1, embed_id1 = "_dark1", 0
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "sofa":
            postfix1, embed_id1 = "_dark1", 0
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "bike":
            postfix1, embed_id1 = "_dark1", 0
        elif os.path.basename(os.path.dirname(os.path.dirname(rgb_file_))) == "shrub":
            postfix1, embed_id1 = "_dark1", 0
        postfix2, embed_id2 = "", 0

        rgb_file = os.path.join(os.path.dirname(rgb_file_) + postfix2, os.path.basename(rgb_file_))
        ...
        if self.mode == "train":
            ...
            rgb_file_test = rgb_file_.replace("high", "low")
            id_render = train_rgb_files.index(rgb_file_test)
        ...
        for id in nearest_pose_ids:
            ...
            src_rgb_file = os.path.join(os.path.dirname(src_rgb_file) + postfix1, os.path.basename(src_rgb_file))
        ...
        return {
            ...
            "embed_id2": torch.LongTensor([embed_id2]),
        }
