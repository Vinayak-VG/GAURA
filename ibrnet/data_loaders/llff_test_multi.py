...
class NeRFLLFFMultiDataset(Dataset):
    
    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        if args.ft_corrup == "None":
            if args.many2many:
                self.CORRUPTIONS_in = [
                ("", 0),
                ("", 0),
        ...
        elif args.ft_corrup == "motionblur":
            self.CORRUPTIONS_in = [
            ("_motion1", 10),
            ("_motion2", 11),
            ("_motion3", 12),
        ...
        elif args.ft_corrup == "newwhitehaze":
            self.CORRUPTIONS_in = [
            ("_newwhitehaze1", 10),
            ("_newwhitehaze2", 11),
            ("_newwhitehaze3", 12),
        ...
        self.folder_path = os.path.join("/data/New_Data_Gen/final_data/nerf_llff_data/")
        self.args = args
    ...
    def __getitem__(self, idx):
        ...
        postfix1, embed_id1 = "_rain_dark_multi", 30
