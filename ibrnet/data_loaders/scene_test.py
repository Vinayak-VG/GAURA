...
class SceneTestDataloader(Dataset):

    def __init__(self, args, mode, scenes=(), random_crop=True, **kwargs):
        self.folder_path = os.path.join("../../test/")
        self.args = args
    ...
    def __getitem__(self, idx):
        ...
        ############################################
        # degradation_type = ("dark", 0), ("haze", 1), ("rain", 2), ("motion", 3), ("burstnoise", 4), ("clean", 5),
        ############################################
        degradation_type = 1
        postfix1, embed_id1 = "", degradation_type
