...
def render_rays(
    ...
    if net == "mlp_ibr":
        ...
        try:
            rgb = model.net_coarse(rgb_feat, ray_diff, mask, pts, ray_d, embed_id1=embed_id1)
        except:
            rgb = model.net_coarse(rgb_feat, ray_diff, mask, pts, ray_d, featmaps[-2], embed_id1=embed_id1)
        if transret_alpha:
