...
def config_parser():
    ...
    parser.add_argument(
        "--rootdir",
        type=str,
        default="/data/cilab4090/restoration_nerf",
    ...
    parser.add_argument("--out_corr", type=str, default="pre_add")
    parser.add_argument("--finetune", action="store_true", help="if finetuning")
    parser.add_argument("--many2many", action="store_true", help="if regularise the embedding")
    parser.add_argument("--folder_name", type=str, default="dehaze-nerf")
    parser.add_argument("--pretrained_allweights", action="store_true", help="if regularise the embedding")
    parser.add_argument("--pretrained_onlyembeds", action="store_true", help="if regularise the embedding")
    parser.add_argument("--typeofmodel", type=str, default="embed")
    parser.add_argument("--ft_corrup", type=str, default="None")
    parser.add_argument("--mask_train", type=str, default="onlymask")
